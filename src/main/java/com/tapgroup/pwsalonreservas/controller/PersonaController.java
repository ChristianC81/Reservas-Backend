...
public class PersonaController {
    ...
    public ResponseEntity<Persona> crearPersona(@RequestBody Persona p) {
        return personaService.postPerson(p);
    }
...
//    }
    @GetMapping("/pernomusuario/{nombre}")
    public ResponseEntity<?> buscarPersonaNombreUsuario(@PathVariable String nombre) {
        return personaService.buscarPersonPorNombreUsuario(nombre);
    }
